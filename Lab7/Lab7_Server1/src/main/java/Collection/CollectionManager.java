...
public class CollectionManager implements Serializable{
    ...
    private static CopyOnWriteArraySet<Movie> movies = new CopyOnWriteArraySet<>();
    ...
    public void setCollection(CopyOnWriteArraySet<Movie> movies){
        this.movies = movies;
    }
    public static CopyOnWriteArraySet<Movie> getCollection(){
        return movies;
    }
    ...
    public CopyOnWriteArraySet<Movie> getMovies() {
        return movies;
    }
